QA_DATASET = [
    ...
    },
    {
        ...
        "response": (
            ...
            "1. Education - AI learning platforms\n"
            "2. Healthcare - AI diagnostics\n"
            "3. Public Sector - Smart governance\n"
            "4. GIS - Geographic mapping\n"
            "5. Data Analytics - BI dashboards\n"
            "6. Professional Services - Workflow automation\n"
            "7. Media & Entertainment - Content recommendation\n"
            "8. Retail - AI personalization\n"
            "9. Real Estate - Property analytics\n"
            "10. Manufacturing - Smart factory automation\n\n"
            "Visit: https://gaintclout.com/"
        )
    },
]
